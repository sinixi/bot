...
class Bot(commands.Cog):
    ...
    async def help(self, ctx, pag='home'):
        if pag == 'home':
            ...
            embed.add_field(name="**<:Monedacapek:551094485250080779> Comandaments de Eloi:**", value="`zz!help eloi`", inline=False)
        ...
        if pag == 'utilitat':
            ...
            embed6.add_field(name="zz!email <email> | <tema> | <cos>", value="**Important: S'ha de posar `|` per separar els parametres**\nEnvia un correu electònic a el email proporcionat com a `ezpezialet@gmail.com`.", inline=False)
    ...
    async def info(self, ctx, language='home'):
        ...
        if language == 'english':
            ...
            embed.set_author(name="Creador: MrOrange9_JCT#9999", icon_url="https://images-ext-2.discordapp.net/external/03DuK9mIngzpX9yLWieJXKLi8sBCcQfNKjOhp3n95QM/%3Fsize%3D256/https/cdn.discordapp.com/avatars/449992158729076746/b50b00cc16ccbf9a72686f3d8e6b4450.png")
            ...
            embed.add_field(name="<:discordbotlist:338808864352763904> Top.gg link (invite) del bot original", value="[Click Here](https://top.gg/bot/553883586210562060)", inline=False)
            embed.add_field(name="<:githublogo:720620633632800779> Github (Catalan) tambe del bot original", value="[Click Here](https://github.com/MrOrange9-JCT/Ezpezialet)", inline=False)
